/*
Definitie sketchStructuralRelationVisualElement class:
figuurtje om een structural relation mee af te beelden
*/

:-pce_begin_class(sketchStructuralRelationVisualElement,
		  sketchGenericRelationVisualElement,
		  "Display of structural relation"
		 ).

%%
initialise(CE,
	   Sketch : sketch,
	   Rel: sketchStructuralRelationElement,
		Device: device,
