/*
Definitie sketchGenericRelationElement class
*/
...
%%
initialise(GR, Arg1: argument1 = sketchElement, %gp3 made this more general
			Arg1Route: chain,
			Arg2 : argument2 = sketchElement, %gp3 made this more general
			Arg2Route: chain,
			Remarks: string):->

	GR->+initialise(Remarks),
	GR->>argument1(Arg1,Arg1Route),
	GR->>argument2(Arg2,Arg2Route).
%%

argument1(GR,Arg : sketchElement, %gp3 made this more general
			ArgRoute: [chain]
	 ):->
	...
	GR->>hyper(Arg,argument1,sketchGenericRelationElement),
	if
		ArgRoute == @default
	then
...
%%
argument2(GR, Arg: sketchElement, %gp3 made this more general
			ArgRoute: [chain]
	):->
	...
	GR->>hyper(Arg,argument2,sketchGenericRelationElement),
	if
		ArgRoute == @default
	then
...
%%
isArgument(GR,
	   Arg: sketchElement, %gp3 made this more general
		ArgRoute: [chain]
          ):->
...
isMoreGeneralRelation(R, Arg1_in: sketchElement, Route1_in: chain,
						  Arg2_in: sketchElement, Route2_in: chain
					  ):->
	%gp3 0.2
...
isSpecializedRelation(R, Arg1_in: sketchElement, Route1_in: chain,
						  Arg2_in: sketchElement, Route2_in: chain
					  ):->
	%gp3 0.2
	%the arguments must be the same object, but this can be reversed
...
sameArguments(R, Arg1_in: sketchElement, Route1_in: chain,
						  Arg2_in: sketchElement, Route2_in: chain
					  ):->
	%gp3 0.2
		Arg1_in = R<<-argument1,
